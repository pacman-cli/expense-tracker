  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#030712] p-4">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute bottom-[-10%] left-[-10%] h-[40%] w-[40%] rounded-full bg-indigo-500/20 blur-[120px]" />
        <div className="absolute bottom-[30%] right-[10%] h-[30%] w-[30%] rounded-full bg-purple-500/10 blur-[100px]" />
      </div>
            ...
            <form onSubmit={handleRegister} className="space-y-5">
              ...
              <div className="relative py-2">
                ...
                <div className="relative flex justify-center text-[10px] uppercase tracking-widest font-bold">
                  <span className="bg-[#030712] px-3 text-muted-foreground/40">Secure Sign Up</span>
                </div>
              </div>
