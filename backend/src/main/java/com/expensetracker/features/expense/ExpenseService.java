...
public class ExpenseService {
    ...
    public ExpenseDTO createExpense(Long userId, ExpenseDTO expenseDTO) {
        ...
        if (expenseDTO.getWalletId() != null) {
            ...
            if (wallet.getBalance().compareTo(expenseDTO.getAmount()) < 0) {
    ...
    public ExpenseDTO updateExpense(Long id, Long userId, ExpenseDTO expenseDTO) {
        ...
        if (!expense.getUser().getId().equals(userId)) {
            throw new UnauthorizedException("Unauthorized access to expense");
        }
        ...
        if (expenseDTO.getWalletId() != null) {
            ...
            if (newWallet.getBalance().compareTo(expenseDTO.getAmount()) < 0) {
                throw new BusinessException("Insufficient wallet balance");
            }
    ...
    public void deleteExpense(Long id, Long userId) {
        ...
        if (!expense.getUser().getId().equals(userId)) {
            throw new UnauthorizedException("Unauthorized: You can only delete your own expenses");
        }
